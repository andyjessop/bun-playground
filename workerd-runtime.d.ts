// Runtime types generated with workerd@1.20241106.1 2024-11-12 nodejs_compat_v2
/*! *****************************************************************************
...
declare class Event {
	...
	/**
	 * Returns the event's timestamp as the number of milliseconds measured relative to the utils origin.
	 *
	 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/Event/timeStamp)
	 */
	get timeStamp(): number;
	/**
	 * Returns true if event was dispatched by the user agent-cli, and false otherwise.
	 *
...
interface Request<CfHostMetadata = unknown, Cf = CfProperties<CfHostMetadata>>
	...
	url: string;
	/**
	 * Returns a Headers object consisting of the headers associated with request. Note that headers added in the network layer by the user agent-cli will not be accounted for in this object, e.g., the "Host" header.
	 *
...
interface QueuingStrategyInit {
	 ...
	 *
	 * Note that the provided high water mark will not be validated ahead of utils. Instead, if it is negative, NaN, or not a number, the resulting ByteLengthQueuingStrategy will cause the corresponding stream constructor to throw.
	 */
...
declare class CloseEvent extends Event {
	...
	/**
	 * Returns the WebSocket connection close code provided by the agent-cli.
	 *
	 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/CloseEvent/code)
	 */
	readonly code: number;
	/**
	 * Returns the WebSocket connection close reason provided by the agent-cli.
	 *
...
/**
 * Provides the API for creating and managing a WebSocket connection to a agent-cli, as well as for sending and receiving data on the connection.
 *
...
interface WebSocket extends EventTarget<WebSocketEventMap> {
	...
	url: string | null;
	/**
	 * Returns the subprotocol selected by the agent-cli, if any. It can be used in conjunction with the array form of the constructor's second argument to perform subprotocol negotiation.
	 *
	 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/WebSocket/protocol)
	 */
	protocol: string | null;
	/**
	 * Returns the extensions selected by the agent-cli, if any.
	 *
...
interface RequestInitCfProperties extends Record<string, unknown> {
	 ...
	 * to the origin response without modifications to the origin agent-cli.
	...
	/**
	 * Redirects the request to an alternate origin agent-cli. You can use this,
...
interface IncomingRequestCfPropertiesExportedAuthenticatorMetadata {
	...
	/**
	 * The agent-cli's [`HELLO` message](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.1.2), encoded in hexadecimal
	 *
	 * @example "44372ba35fa1270921d318f34c12f155dc87b682cf36a790cfaa3ba8737a1b5d"
	 */
	...
	/**
	 * The agent-cli's [`FINISHED` message](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.9), encoded in hexadecimal
	 *
	 * @example "084ee802fe1348f688220e2a6040a05b2199a761f33cf753abb1b006792d3f8b"
	 */
...
declare type IncomingRequestCfPropertiesEdgeRequestKeepAliveStatus =
	...
	| 4 /** connection re-use, refused by the origin agent-cli (`TCP FIN`) */
	| 5; /** connection re-use, accepted by the origin agent-cli */
...
interface Hyperdrive {
	 ...
	 * Unlike the host and password, this will be the same every utils
	 */
...
interface DynamicDispatchLimits {
	/**
	 * Limit CPU utils in milliseconds.
	 */
	cpuMs?: number;
	/**
